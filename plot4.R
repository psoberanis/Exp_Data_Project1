...
par(mfrow=c(2,2))
with(feb1and2,{
  plot(Global_active_power/500,type="l",ylab="Global Active Power (Kilowats)",xaxt="n",xlab="")
  axis(1, at=seq(0,2880,by=1440), labels=c("Thu","Fri","Sat"))
  plot(Voltage,type="l",xaxt="n",xlab="datetime",ylab=colnames(data1[5]))
  axis(1, at=seq(0,2880,by=1440), labels=c("Thu","Fri","Sat"))
  plot(Sub_metering_1,type="l",ylab="Energy sub metering",xaxt="n",col="black",xlab="")
  points(Sub_metering_2,type="l",xaxt="n",col="red")
  points(Sub_metering_3,type="l",xaxt="n",col="blue")
  axis(1, at=seq(0,2880,by=1440), labels=c("Thu","Fri","Sat"))
  legend("topright",lty=c(1,1,1),col=c("black","red","blue"),legend=colnames(data1[7:9]))
  plot(Global_reactive_power,type="l",xaxt="n",xlab="datetime",ylab=colnames(data1[4]))
  axis(1, at=seq(0,2880,by=1440), labels=c("Thu","Fri","Sat"))
})
dev.off()